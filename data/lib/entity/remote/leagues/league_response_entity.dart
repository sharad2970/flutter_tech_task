...
part 'league_response_entity.g.dart';

@JsonSerializable()
class LeagueResponseEntity
    implements BaseLayerDataTransformer<LeagueResponseEntity, Leagues> {
  ...
  factory LeagueResponseEntity.fromJson(Map<String, dynamic> json) =>
      _$LeagueResponseEntityFromJson(json);

  Map<String, dynamic> toJson() => _$LeagueResponseEntityToJson(this);

  @override
  LeagueResponseEntity restore(data) {
