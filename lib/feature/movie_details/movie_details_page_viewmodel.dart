...
class MovieDetailsPageViewModel extends BasePageViewModel {
  ...
  MovieDetailsPageViewModel(this._homeUseCase, this._movieDetailsPageArguments) {
  ...
  List<String> getImageList(List<PopularMovies> data) {
    ...
    data.forEach((element) {
      (element.posterPath != null) ? list.add(element.posterPath)
          : (element.backdropPath != null)
          ? list.add(element.backdropPath) : list.add('');
